...
export const Button2 = () => {
  ...
  return (
    ...
    >
      <span className="absolute inset-[-1000%] animate-[spin_2s_linear_infinite] bg-[conic-gradient(from_90deg_at_50%_50%,#E2CBFF_0%,#393BB2_50%,#E2CBFF_100%)]" />
      <span className="inline-flex h-full w-full gap-4 cursor-pointer items-center justify-center rounded-lg bg-slate-950 px-5 text-xs sm:text-sm font-medium text-white backdrop-blur-3xl uppercase">
        Download CV
      </span>
    </button>
  );
